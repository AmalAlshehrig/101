...
function SideBAr() {
  return (
    ...
    <a href="#">
        <img class="w-auto h-7" src="https://assets-global.website-files.com/6364e65656ab107e465325d2/637aee4a51438bb71d4fbbb8_fXc0ANChBFmFF1vzqX29v4i4gQDLf5OyYdw46XMGiJ0.png" alt=""/>
    </a>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="flex-1 -mx-3 space-y-3 ">
            ...
            <Link  
            to={`/Home101/${localStorage.getItem('Username')}`}
            class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
            ...
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                ...
                <span class="mx-2 text-sm font-medium">Search</span>
            </a>
            ...
            <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                ...
                <span class="mx-2 text-sm font-medium">Lists</span>
            </a>
            ...
            <div class="flex items-center justify-between mt-6">
                <a href="#" class="flex items-center gap-x-2">
                    <img class="object-cover rounded-full h-7 w-7" src="https://static.thenounproject.com/png/4851855-200.png" alt="avatar" />
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-200">{localStorage.getItem('Username')}</span>
                </a>
                
                <Link to={'/'} class="text-gray-500 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
